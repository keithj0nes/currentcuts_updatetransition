...
select products.name, products.img1, sizes.height, sizes.width, prices.price, orderline.quantsold, orderline.color, orders.datesold, orders.ordertotal from orderline
join orders on orderline.orderid = orders.id
join products on orderline.productid = products.id
